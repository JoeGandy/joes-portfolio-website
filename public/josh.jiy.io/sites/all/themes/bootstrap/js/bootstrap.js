jQuery(".home_slider_image").each(function() {
  console.log(jQuery(this).children('img').attr('src'));
  var url = jQuery(this).children('img').attr('src');
  jQuery(this).children('img').remove();
  jQuery(this).append("<div style='width:100%;height:100%;background: url("+url+") no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;'></div>")
});
